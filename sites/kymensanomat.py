...
def parse( url ):
	...
	categories = processor.collect_categories( menu.find( class_ = 'selected' ) )
	...
	return processor.create_dictionary('Kymen sanomat', url, r.status_code, categories, datetime_list, author, title, u'', text, images, captions)
